                ...
                <div class="blog-info overflow-initial">
                    ...
                    <div id="social" style="margin-bottom: 45px;">
                        <div class="social-main">
                            <span class="like">
                                <a href="javascript:doPraise(${article.id?c});" data-id="${article.id?c}" title="点赞" ><i class="fa fa-thumbs-up"></i>赞 <i class="count"> ${article.loveCount!(0)}</i> </a>
                            </span>
                            <div class="shang-p">
...
<@footer>
    ...
    <script type="text/javascript" src="../js/yzyTools.js"></script>
</@footer>
