...
<@header title="${config.siteName} | youzhiyong的个人博客"
            ...
            <div class="scrolltext">
                <ul class="list-unstyled" id="notice-box">
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark" target="_blank"><strong>每天都会不定期更新哟</strong></a>
                    </li>
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">评论区已开放，欢迎大家前来吐槽</a>
                    </li>
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">新店开业，欢迎投稿</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <article class="fade-in">
                        <figure class="thumbnail">
                            <a href="${config.siteUrl}/article/${item.id?c}">
                                <#if item.coverImage?exists && (item.coverImage?length > 7)>
                                    <img width="150" height="150" data-original="${config.qiuniuBasePath}${item.coverImage}!hw150px" class="img-responsive lazy-img" alt="${item.title?if_exists}">
                                <#else>
                        ...
                        <div class="entry-content">
                            ...
                            <span class="entry-meta">
                                ...
                                <span class="praise" title="文章点赞数" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-thumbs-o-up fa-fw"></i>赞(${item.loveCount!(0)})</span>
