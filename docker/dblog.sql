...
-- 建库 
CREATE DATABASE IF NOT EXISTS dblog default charset utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `biz_article` (
  ...
  `create_time` char(14) DEFAULT "20180914165100" COMMENT '添加时间',
  `update_time` char(14) DEFAULT "20180914165100" COMMENT '更新时间',
...
CREATE TABLE `biz_article_look` (
  ...
  `look_time` char(14) DEFAULT "20180914165100" COMMENT '浏览时间',
  `create_time` char(14) DEFAULT "20180914165100" COMMENT '添加时间',
  `update_time` char(14) DEFAULT "20180914165100" COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `biz_article_love` (
  ...
  `user_id` bigint(20) unsigned DEFAULT NULL COMMENT '已登录用户ID',
  `user_ip` varchar(50) DEFAULT NULL COMMENT '用户IP',
  `love_time` char(14) DEFAULT NULL COMMENT '浏览时间',
  `create_time` char(14) DEFAULT "20180914165100" COMMENT '添加时间',
  `update_time` char(14) DEFAULT "20180914165100" COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_config` (
  ...
  `maintenance_data` char(14) DEFAULT "20180914165100" COMMENT '系统维护时间',
...
CREATE TABLE `sys_update_recorde` (
  ...
  `recorde_time` char(14) DEFAULT "20180914165100" COMMENT '项目更新时间',
  `create_time` char(14) DEFAULT "20180914165100" COMMENT '添加时间',
  `update_time` char(14) DEFAULT "20180914165100" COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `sys_user` (
  ...
  `last_login_time` char(14) DEFAULT NULL COMMENT '最近登录时间',
  `login_count` int(10) unsigned DEFAULT '0' COMMENT '登录次数',
  `remark` varchar(100) DEFAULT NULL COMMENT '用户备注',
  `status` int(1) unsigned DEFAULT NULL COMMENT '用户状态',
  `create_time` char(14) DEFAULT "20180914165100" COMMENT '注册时间',
  `update_time` char(14) DEFAULT "20180914165100" COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
